				...
				.on(
						...
						function(event) {
							...
							if (gNo == 0) {
								...
								location.href = "${pageContext.request.contextPath}/league/receiptForm?lkName="
										+ leagueName;
							}
...
<div class="list_wrap">
	<div class="tab_wrap">
		<ul>
			...
			<li class="on"><a
				href="http://localhost:8080/football/reservation">리그소개</a></li>
	...
	<div class="rese_wrap">
		<div class="match_wrap">
			<form method="POST" name="form" id="f1"
				action="${pageContext.request.contextPath}/league/resist" enctype="multipart/form-data">
				...
				<div class="fl_wrap">
					...
					<div class="input_wrap">
						<p>신청자명</p>
						<input type="text" class="input_fo" name="lName"
							style="width: 100%" value="${login.mName }" readonly="readonly">
					</div>

					<div class="input_wrap">
						<p>연락처</p>
						<input type="text" class="input_fo" name="lTel"
							style="width: 100%" value="${login.mTel }" readonly="readonly">
					</div>

					<div class="input_wrap">
						<p>리그종류</p>
						<select class="select_all" id="sel_spot2"
							name="lLeagueName.lkName">
					...
					<div class="input_wrap">
						<p>팀명</p>
						<input type="text" class="input_fo" style="width: 100%"
							name="lTeam.tName">
					</div>

					<div class="input_wrap">
						<p>팀코드</p>
						<input type="password" class="input_fo" style="width: 100%"
							name="lTeam.tCode">
					</div>

					<div class="input_wrap">
						<p>팀마크</p>
						<input class="input_fo" type="file" name="file"
							style="width: 100%">
					</div>
				...
				<div class="btn_wrap">
					<input type="submit" value="등록하기" class="btn_big" id=""> <a
						href="${pageContext.request.contextPath}/league"
						class="btn_big gray" id="del_match">취소하기</a>
				</div>
			</form>
