	...
	<section id="container">
		...
		<div class="content">
			<div class="member_wrap">
				...
				<div class="join_wrap">
					<span class="chk"><input type="checkbox" id="join_01" title="" name="a" onclick="checkAll(this);"><label for="join_01">이용약관, 개인정보 수집 및 이용, 개인정보취급위탁에 모두 동의합니다.</label></span>

					<span class="chk"><input type="checkbox" id="join_02" title="" name="c"><label for="join_02">HM풋살파크 홈페이지 이용약관 안내 <span>(필수)</span></label></span>
					<div class="turm_wrap">
						<div class="t_wrap">
							<p>제 1 장 총 칙</p>
					...
					<span class="chk"><input type="checkbox" id="join_03" title="" name="c"><label for="join_03">개인정보 수집 및 이용에 대한 안내 <span>(필수)</span></label></span>
					<div class="turm_wrap">
						<div class="t_wrap">
							<p>HM스포츠(이하 회사)는 회원으로 가입한 이용자의 개인정보 보호를 위해 구체적 방침을 명시한 개인정보 보호정책을 제정하여 준수합니다.<br>본 보호정책은 관계 법령의 변경 및 회사이 제공하는 서비스의 내용변경에 따라 바뀔 수 있으므로 HM스포츠 홈페이지를 방문 시 수시로 확인하시기 바랍니다.</p>
					...
					<span class="chk"><input type="checkbox" id="join_04" title="" name="c"><label for="join_04">개인정보 취급위탁 안내 <span>(필수)</span></label></span>
					<div class="turm_wrap">
						<div class="t_wrap">
					...
					<div class="btn_wrap">
						<a href="/football/" class="btn_middle gray">비동의</a>
						<a href="#" onclick="confirm();" class="btn_middle">동의</a>
					</div>
...
function confirm(){ 
	...
	document.location.href="${pageContext.request.contextPath }/auth/join2";
}
</script>
	<!-- Footer -->
	<footer id="footer">
